...
export const VersionsTabView = OCA.Files.DetailTabView.extend(
	/** @lends VersionsTabView.prototype */ {
	id: 'snapshotsTabView',
	...
	template: function(data) {
		if (!this._template) {
			this._template = require('./templates/template.handlebars');
		}
	...
	itemTemplate: function(data) {
		if (!this._itemTemplate) {
			this._itemTemplate = require('./templates/item.handlebars')
		}
